...
BLACKHORIZON_BANNER = 'TNK Layer7 Tool xV0.1'
...
def usage():
    print BLACKHORIZON_BANNER 
    print ' USAGE: ./tnk_l7.py http://www.target.com/ [OPTIONS]'
...
print \
"""                                                       
 _________  ____  _____  ___  ____    _____   _______  
|  _   _  ||_   \|_   _||_  ||_  _|  |_   _| |  ___  | 
|_/ | | \_|  |   \ | |    | |_/ /      | |   |_/  / /  
    | |      | |\ \| |    |  __'.      | |   _   / /   
   _| |_    _| |_\   |_  _| |  \ \_   _| |__/ | / /    
  |_____|  |_____|\____||____||____| |________|/_/     
